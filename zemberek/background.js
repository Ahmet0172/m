function ayikla(txt){
	$(document).ready(function(){ // jquery document başlatılıyor
		$.post("http://localhost/chorme/chorme/zemberek/islem.php",{text:txt},function(sonuc,sc){ // belirtilen yola post olarak fonksiyon parametresi gönderiliyor sonuc degiskeninde sayfadan gelen sonucu alıyoruz
